    ...
    def __init__(self, multiplier=1):
        ...
        for i in range(0, self.multiplier):
            for j in range(0, 4):
                ...
                if j == 0:
                    self.cards.append(Card('Clubs', 'Black', 'Ace', 10))
                    ...
                    self.cards.append(Card('Diamonds', 'Red', 'Ace', 10))
                    ...
                    self.cards.append(Card('Hearts', 'Red', 'Ace', 10))
                    ...
                    self.cards.append(Card('Spades', 'Black', 'Ace', 10))
        ...
        self.cards.insert(int(len(self.cards)* 0.8), Card('Red Card', 'None', 'None', 0))
